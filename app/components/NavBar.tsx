...
const NAV_INFO = [
  // ["home", "w-12", "/"],
  ["projects", "w-16", "#project"],
  ["services", "w-16", "#services"],
  ["about", "w-12", "#about"],
  // ["contact", "w-16", "#footer"],
];
  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="w-[9.75rem] flex flex-col justify-center items-center after:content-[''] after:w-full after:h-[0.09rem] after:bg-[--color--heading] after:block  pb-2 capitalize text-xl tracking-wide hover:tracking-wider transition-[letter-spacing] ease-out duration-100"
      >
        <div className="flex">
          Get In Touch
          <svg
