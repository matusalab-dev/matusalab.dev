...
export const HEADER_COPYRIGHT: HeaderCopyTypes[] = [
  {
    ...
    description:
      ...
      "Hi, I’m Matusala Abrha, I’m a creative React Developer with a degree in Electrical and Computer Engineering and a passion for building meaningful digital experiences. I work with Shopify, using HTML, CSS, JavaScript, Alpine.js, and Liquid to create custom themes and unique features that meet my clients’ needs. My goal is to design responsive, user-friendly interfaces that make a real impact. Let’s bring your ideas to life together!",
  },
  {
    tags: ["React", "Next.js"],
    headline: ["Front-End", "Shopify"],
