...
export const HEADER_COPYRIGHT: HeaderCopyTypes[] = [
  {
    ...
    description:
      ...
      "Hi there, I’m Matusala Abrha, Next.js & Shopify Developer specializing in headless eCommerce and high-conversion storefronts. Built the Mhur LMS with Next.js, during my internship at Blih Marketing and Comm. plc. Now freelancing, developing custom Shopify solutions like CRO features, high-performance pages, and dynamic sections using HTML&CSS, Web-Components, Liquid, Next.js, GraphQL, Alpine.js to optimize UX and drive sales.",
  },
  {
    tags: ["React", "Next.js"],
